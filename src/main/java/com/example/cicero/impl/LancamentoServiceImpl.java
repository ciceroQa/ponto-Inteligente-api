...
import com.example.cicero.repositories.LancamentoRepository;
import com.example.cicero.services.LancamentoService;
...
public class LancamentoServiceImpl implements LancamentoService {
	...
	public Page<Lancamento> buscarPorFuncionarioId(Long funcionarioId, PageRequest pageRequest) {
		log.info("Buscar lancamentos parao Funcionario ID {}", funcionarioId);
